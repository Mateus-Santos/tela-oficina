...
class StoreAnexoRequest extends FormRequest
{
    ...
    {
        return [
            'arquivo' => ['required', 'file', 'max:2048', 'mimes:pdf,jpg,jpeg,png,webp,xml'],
            'tipo' => [
                'required',
                'string',
                'max:50',
    ...
    public function messages(): array
    {
        return [
            ...
            'arquivo.max' => 'O arquivo não pode ter mais de 2 MB.',
            'arquivo.mimes' => 'O arquivo deve ser PDF, JPG, JPEG, WEBP ou XML.',
