...
<section class="container cadastro">
    ...
    <h1><i class="bi bi-gear"></i> EDITAR PRODUTO</h1>
        ...
        <div class="campos">
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" inputmode="numeric" class="form-control" id="preco_uni" name="preco_uni" value="{{ $produto->preco_uni }}" required>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="codigo_fabricante" name="codigo_fabricante" value="{{ $produto->codigo_fabricante }}" required>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-2">
                    ...
                    <input class="form-control" type="text" value="{{ $produto->marca }}">
                </div>
