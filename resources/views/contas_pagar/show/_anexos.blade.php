    ...
    <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        ...
                        >
                            ...
                            <option value="orcamento" @selected(old('tipo') === 'orcamento')>
                                Orçamento
                            </option>
                            <option value="recibo" @selected(old('tipo') === 'recibo')>
                                Recibo
                            </option>
                            <option value="foto" @selected(old('tipo') === 'foto')>
                                Foto
                            </option>
                            <option value="conta_luz" @selected(old('tipo') === 'conta_luz')>
                                Conta de luz
                            </option>
                            <option value="conta_agua" @selected(old('tipo') === 'conta_agua')>
                                Conta de água
                            </option>
                            <option value="conta_telefone" @selected(old('tipo') === 'conta_telefone')>
                                Conta de telefone
                            </option>
        ...
        @if ($conta->anexosVinculos->isEmpty())
            ...
            <div class="text-center text-muted py-4">
                ...
                Nenhum anexo vinculado a esta conta.
            </div>
