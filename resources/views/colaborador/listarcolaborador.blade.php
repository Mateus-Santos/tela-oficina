...
<div class="container cadastro">
    ...
    <table class="table">
        ...
        <tbody>
            ...
            <td><a href="/colaboradores/edit/{{$colaborador->id_colaborador}}" class="btn btn-info"><i class="bi bi-pencil-square"></i>Editar</a></td>
            <td>
                <form action="/colaboradores/{{$colaborador->id_colaborador}}" method="post">
                    @csrf
                    @method('DELETE')
